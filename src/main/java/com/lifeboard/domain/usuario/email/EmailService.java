package com.lifeboard.domain.usuario.email;
...
public class EmailService {
    ...
    private static final String EMAIL_ORIGEM = "lifeboard@email.com";
    private static final String NOME_ENVIADOR = "Lifeboard";
    ...
    public void enviarEmailSenha(Usuario usuario) {
        ...
        String conteudo = gerarConteudoEmail("Olá [[name]],<br>"
                ...
                + "Obrigado,<br>"
                + "LifeBoard.", usuario.getNome(), URL_SITE + "/recuperar-conta?codigo=" + usuario.getToken());
